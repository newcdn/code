...
<head>
    ...
    <meta name="keywords" content="<?php echo $n_path;?>,<?php if ($p_path!='') echo $p_path.','; echo $_SERVER['sitename'];?>,OneManager,有趣盘">
...
.btn-gradient {
  color: white;
  /*background: linear-gradient(100deg, #00dbde, #fc00ff, #00dbde);*/
  background: linear-gradient(100deg, #0000CD, #FF0000, #B23AEE);
  background-size: 300%;
  border-radius: 2em;
...
<div class="footer_copyright">
 Copyright © 2019-2020 - <span id="footyear"></span>有趣盘 <em> 本网盘归 - YOUQV.COM - 版权所有</em>               
</div>
